...
class HarmonyFundGiveWPDonations {
    ...
    public function __construct() {
      // add_filter( 'gettext', array($this,'hf_change_form_text'), 200, 3 );
      // add_action( 'give_pre_form', array($this, 'hf_before_give_form'), 10000, 2 );
      ...
      // add_filter('give_form_level_output', array($this, 'hf_show_give_monthly_tab'), 1, 2);
      // add_filter( 'give_form_level_text',  array($this, 'hf_show_give_monthly_tab'), 10, 3 );
 
    } // end function construct

    // public function hf_change_form_text($translated_text, $text, $domain) {

    //   if($domain == 'give') {
    //     wl($translated_text);
    //     switch ( $translated_text ) {
    //       case 'Custom Amount':
    //           $translated_text = __( 'Custom', 'give');
    //       break;
    //     }
    //   }
    ...
    public function hf_give_form_content_output($output, $form_id, $args) {
        ...
        // $hf_output .= '<div class="hf-give-form-featured-image">' . get_the_post_thumbnail($form_id) . '</div>';
        ...
        // $hf_output .= '<h2 class="hf-give-form-title">' . get_the_title( $form_id ) . '</h2>';
        
        $hf_output .= '<div class="hf-content-wrap">' . $output . '</div>';

        $hf_output .= '</div>'; // #hf-give-form-content-wrap

        // $hf_output .= '<div class="hf-form-gutter"></div>';
        return $hf_output;
    

    }
    // public function hf_before_give_form($output, $form_id) {
    //     echo "pizza";
    // }
