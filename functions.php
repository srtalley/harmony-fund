...
function wmpudev_enqueue_icon_stylesheet() {
    ...
    // wp_register_style( 'harmonyfund-givewp', get_stylesheet_directory_uri() . '/harmonyfund-givewp.css' );
    wp_enqueue_style( 'harmonyfund-givewp' );
		wp_enqueue_script( 'harmonyfund-givewp', get_stylesheet_directory_uri() . '/harmonyfund-givewp.js', '', '1.0', true );
}
...
// Defer Javascript in WordPress https://gist.github.com/alexander-young/af8f9305920cd0f5325646049c146552
